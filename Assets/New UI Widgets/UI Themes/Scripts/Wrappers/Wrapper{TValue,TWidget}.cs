namespace UIThemes.Wrappers
{
		...
		where TWidget : Component
	{
		...
		/// Widget type.
		/// </summary>
		public Type Type => typeof(TWidget);
		...
		public TValue Get(Component component) => Get(component as TWidget);
		...
		public bool Set(Component component, TValue value, IEqualityComparer<TValue> comparer)
		{
			...
			if (component is TWidget widget)
			{
				Set(widget, value);
				return true;
			}
		...
		public bool Active(Component component) => (component is TWidget w) && Active(w);
		...
		/// <param name="widget">Widget.</param>
		/// <returns>true if property active; otherwise false.</returns>
		protected virtual bool Active(TWidget widget) => true;
		...
		public virtual bool ShouldAttachValue(Component component) => (component is TWidget w) && ShouldAttachValue(w);
		...
		/// <param name="widget">Widget.</param>
		/// <returns>true if should attach value; otherwise false.</returns>
		protected virtual bool ShouldAttachValue(TWidget widget) => true;
	}
}