...
namespace UIThemes
{
	...
	public static class ReferencesGUIDs
	{
		...
		/// Default USS GUID.
		/// </summary>
		public const string EditorUSSGUID = "880339e54e64f8c4a944f703da1869d6";

		/// <summary>
		/// Add stylesheet.
		/// </summary>
		/// <param name="styleSheet">Stylesheet.</param>
		public static void AddStyleSheet(StyleSheet styleSheet) => StaticFields.Instance.StyleSheetsAdd(styleSheet);

		/// <summary>
		/// Get stylesheets.
		/// </summary>
		/// <returns>Stylesheets.</returns>
		public static IReadOnlyCollection<StyleSheet> GetStyleSheets() => StaticFields.Instance.StyleSheetsAll();
	}
}
#endif