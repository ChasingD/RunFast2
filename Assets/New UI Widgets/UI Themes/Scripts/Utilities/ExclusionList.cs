namespace UIThemes
{
	...
	public class ExclusionList
	{
		...
		{
			readonly ExclusionList list;

			/// <summary>
			/// Initializes a new instance of the <see cref="Disposable"/> struct.
			/// </summary>
			/// <param name="instance">Instance.</param>
			public Disposable(ExclusionList instance) => list = instance;

			/// <summary>
			/// Dispose (release list).
			/// </summary>
			public void Dispose() => list.Return();
		}

		static Stack<ExclusionList> Cache => StaticFields.Instance.ExclusionListCache;
		...
		/// <example>using var _ = ExclusionList.Get(components, out var list);</example>
		public static Disposable Get(IReadOnlyList<Component> components, out ExclusionList list) => new Disposable(list = Get(components));
