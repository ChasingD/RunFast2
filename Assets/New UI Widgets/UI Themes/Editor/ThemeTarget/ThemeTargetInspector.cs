...
namespace UIThemes.Editor
{
	...
	public class ThemeTargetInspector : Editor
	{
		...
		/// Properties cache.
		/// </summary>
		protected static Dictionary<Type, Func<Target, bool>> PropertiesCache => EditorStaticFields.Instance.ThemeTargetInspectorCache;
		...
		protected virtual VisualElement CreateActions(bool hasMissingComponents)
		{
			...
			actions.Add(Button(Refresh, "Update Targets List", "theme-target-action"));
