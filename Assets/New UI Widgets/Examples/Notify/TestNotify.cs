namespace UIWidgets.Examples
{
	...
	public class TestNotify : MonoBehaviour
	{
		...
		/// Game object in Hierarchy window, parent game object should have Layout component (recommended EasyLayout).
		/// </summary>
		[SerializeField]
		...
		{
			NotificationTemplate.Clone().Show("Notification message.", customHideDelay: 3f, hideAnimation: NotificationBase.AnimationCollapseHorizontal);
		}
		...
		{
			NotificationTemplate.Clone().Show("Notification message.", customHideDelay: 3f, hideAnimation: NotificationBase.AnimationRotateHorizontal);
		}
