...
namespace UIWidgets
{
	...
	public class ListViewCustomBaseEditor : UIWidgetsMonoEditor
	{
		...
		/// Properties indents.
		/// </summary>
		protected readonly IReadOnlyDictionary<string, int> Indents = new Dictionary<string, int>()
		{
			{ "ChangeLayoutType", 1 },
		...
		/// Scroll properties.
		/// </summary>
		protected readonly IReadOnlyList<string> ScrollFields = new List<string>()
		{
		...
		/// </summary>
		protected readonly Func<ListViewCustomBaseEditor, bool> AllowAlways = editor => true;
		...
		/// Coloring fields.
		/// </summary>
		protected readonly IReadOnlyList<FieldCondition> ColoringFields = new List<FieldCondition>()
		{
			new FieldCondition("coloringStriped", EditorStaticFields.Instance.ListViewAllowAlways),
			new FieldCondition("defaultColor", EditorStaticFields.Instance.ListViewAllowAlways),
			...
			new FieldCondition("highlightedColor", EditorStaticFields.Instance.ListViewAllowAlways),
			new FieldCondition("highlightedBackgroundColor", EditorStaticFields.Instance.ListViewAllowAlways),
			new FieldCondition("selectedColor", EditorStaticFields.Instance.ListViewAllowAlways),
			new FieldCondition("selectedBackgroundColor", EditorStaticFields.Instance.ListViewAllowAlways),
			new FieldCondition("disabledColor", EditorStaticFields.Instance.ListViewAllowAlways),

			new FieldCondition("FadeDuration", EditorStaticFields.Instance.ListViewAllowAlways),
			new FieldCondition("KeepHighlight", EditorStaticFields.Instance.ListViewAllowAlways),
			new FieldCondition("OnlyOneHighlighted", EditorStaticFields.Instance.ListViewAllowAlways),
		};

		/// <summary>
		/// Exclude properties and events.
		/// </summary>
		protected readonly IReadOnlyList<string> Exclude = new List<string>()
		{
			"selectedIndices",
			"sort",
			"KeepSelection",
		...
		/// </summary>
		protected readonly IReadOnlyList<string> Hidden = new List<string>()
		{
			// ListViewBase
			"instances",
			"DestroyGameObjects",
		...
		{
			var type = baseType;
			var lv2data = EditorStaticFields.Instance.ListView2DataType;
			if (lv2data.TryGetValue(type, out var data_type))
			{
				return data_type;
			}
		...
		protected void AddProperty(SerializedProperty property, Type type)
		{
			...
			if (Widgets.IsEvent(property, type))
			{
		...
		/// List type.
		/// </summary>
		protected ListViewType ListType => (ListViewType)SerializedProperties["listType"].intValue;
