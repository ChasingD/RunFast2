...
namespace UIWidgets
{
	...
	public static class MenuOptions
	{
		...
		/// Create FileTable.
		/// </summary>
		[MenuItem("GameObject/UI/New UI Widgets/Collections/FileTable", false, 1045)]
		public static void CreateFileTable()
		{
			Create(Prefabs.FileTable);
		}
		...
		/// Create DatePicker.
		/// </summary>
		[MenuItem("GameObject/UI/New UI Widgets/Dialog Templates/DatePicker", false, 3010)]
		public static void CreateDatePicker()
		{
			Create(Prefabs.DateYearListPicker);
		}

		/// <summary>
		/// Create DateYearSpinnerPicker.
		/// </summary>
		[MenuItem("GameObject/UI/New UI Widgets/Dialog Templates/DateYearSpinnerPicker", false, 3020)]
		public static void CreateDateYearSpinnerPicker()
		{
			Create(Prefabs.DateYearSpinnerPicker);
		}

		/// <summary>
		/// Create DateTimePicker.
		/// </summary>
		[MenuItem("GameObject/UI/New UI Widgets/Dialog Templates/DateTimePicker", false, 3030)]
		...
		/// Create Dialog.
		/// </summary>
		[MenuItem("GameObject/UI/New UI Widgets/Dialog Templates/Dialog", false, 3040)]
		...
		/// Create FileDialog.
		/// </summary>
		[MenuItem("GameObject/UI/New UI Widgets/Dialog Templates/FileDialog", false, 3050)]
		...
		/// Create FolderDialog.
		/// </summary>
		[MenuItem("GameObject/UI/New UI Widgets/Dialog Templates/FolderDialog", false, 3060)]
		...
		/// Create Notify.
		/// </summary>
		[MenuItem("GameObject/UI/New UI Widgets/Dialog Templates/Notification", false, 3070)]
		...
		/// Create PickerBool.
		/// </summary>
		[MenuItem("GameObject/UI/New UI Widgets/Dialog Templates/PickerBool", false, 3080)]
		...
		/// Create PickerIcons.
		/// </summary>
		[MenuItem("GameObject/UI/New UI Widgets/Dialog Templates/PickerListViewIcons", false, 3090)]
		...
		/// Create PickerInt.
		/// </summary>
		[MenuItem("GameObject/UI/New UI Widgets/Dialog Templates/PickerInt", false, 3100)]
		...
		/// Create PickerString.
		/// </summary>
		[MenuItem("GameObject/UI/New UI Widgets/Dialog Templates/PickerString", false, 3110)]
		...
		/// Create Popup.
		/// </summary>
		[MenuItem("GameObject/UI/New UI Widgets/Dialog Templates/Popup", false, 3120)]
		...
		/// Create TimePicker.
		/// </summary>
		[MenuItem("GameObject/UI/New UI Widgets/Dialog Templates/TimePicker", false, 3130)]
		...
		{
			Create(Prefabs.CalendarYearList);
		}

		/// <summary>
		/// Create CalendarYearSpinner.
		/// </summary>
		[MenuItem("GameObject/UI/New UI Widgets/Input/CalendarYearSpinner", false, 4025)]
		public static void CreateCalendarYearSpinner()
		{
			Create(Prefabs.CalendarYearSpinner);
		}
