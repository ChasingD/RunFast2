...
namespace UIWidgets
{
	...
	public static class ScriptsRecompile
	{
		...
		public static void Run()
		{
			...
			Check(ReferenceGUID.Instance.TMProStatus, ReferenceGUID.Instance.TMProSupport);
#endif

#if UIWIDGETS_DATABIND_SUPPORT
			Check(ReferenceGUID.Instance.DataBindStatus, ReferenceGUID.Instance.DataBindSupport);
#endif

#if UIWIDGETS_I2LOCALIZATION_SUPPORT
			Check(ReferenceGUID.Instance.I2LocalizationStatus, ReferenceGUID.Instance.I2LocalizationSupport);
#endif
		}
