...
namespace UIWidgets
{
	...
	public class StyleTextPropertyDrawer : PropertyDrawer
	{
		...
		/// The properties.
		/// </summary>
		protected readonly List<string> Properties = new List<string>()
		{
			"Font",
			"FontStyle",
			"Size",
		...
		/// </summary>
		protected readonly List<string> WithHeader = new List<string>()
		{
			"Font",
			"Alignment",
			"Color",
		...
		protected bool IsHeader(string name) => WithHeader.Contains(name);
		...
		/// <param name="name">Name.</param>
		/// <param name="property">Property.</param>
		protected Rect DrawToggableProperty(Rect position, string name, SerializedProperty property)
		{
		...
		/// <param name="name">Name.</param>
		/// <param name="property">Property.</param>
		protected float GetPropertyHeight(string name, SerializedProperty property)
		{
