...
namespace UIWidgets.WidgetGeneration
{
	...
	public abstract class PrefabGenerator
	{
		...
		/// DataBind types.
		/// </summary>
		protected readonly List<string> DataBindTypes = new List<string>()
		{
			"Autocomplete",
			"Combobox",
			"ListView",
		...
		/// Theme.
		/// </summary>
		protected UIThemes.Theme Theme;

		/// <summary>
		/// Theme Variation ID.
		/// </summary>
		protected UIThemes.VariationId ThemeVariation;
#endif
		...
		protected PrefabGenerator(DataPath paths)
		{
#if UITHEMES_INSTALLED
			Theme = UIThemes.ReferencesGUIDs.DefaultTheme;
			if (Theme == null)
			{
				Theme = UIThemes.ThemesReferences.Instance.Current;
			}
		...
		protected virtual void GenerateDataBindSupport()
		{
			...
			var databind_path = Paths.Scripts + Path.DirectorySeparatorChar + "DataBindSupport";
...
#endif
#if !UITHEMES_INSTALLED
			listView.DefaultBackgroundColor = Color.clear;
			listView.DefaultColor = Color.white;
			listView.HighlightedBackgroundColor = new Color32(208, 245, 255, 255);
			listView.HighlightedColor = Color.black;
			listView.SelectedBackgroundColor = new Color32(102, 171, 220, 255);
			listView.SelectedColor = Color.black;
			listView.DisabledColor = new Color32(200, 200, 200, 128);
			listView.DefaultEvenBackgroundColor = new Color32(44, 138, 191, 255);
			listView.DefaultOddBackgroundColor = new Color32(41, 129, 178, 255);

			var drop = listView.GetComponentInChildren<ListViewDropIndicator>(true);
			UIWidgets.Utilities.RequireComponent<Image>(drop).color = new Color32(57, 72, 85, 255);

			UIWidgets.Utilities.RequireComponent<Image>(sr.viewport).color = Color.white;
#endif
...
#endif
#if !UITHEMES_INSTALLED
			UIWidgets.Utilities.RequireComponent<Image>(scrollbar).color = Color.clear;

			var handle = UIWidgets.Utilities.RequireComponent<Image>(scrollbar.handleRect);
			handle.color = new Color32(102, 171, 220, 255);
#endif
		}
...
#endif
#if !UITHEMES_INSTALLED
			UIWidgets.Utilities.RequireComponent<Image>(tableHeader).color = new Color32(32, 101, 140, 255);
#endif
		}
		...
		protected GameObject Save(GameObject go)
		{
			...
			var filename = Paths.Prefabs + Path.DirectorySeparatorChar + go.name + ".prefab";
		...
		protected void GenerateScene()
		{
			...
			Compatibility.SceneSave(Paths.Base + Path.DirectorySeparatorChar + Info.ShortTypeName + ".unity");
		}

		/// <summary>
		/// Default size of the created game objects.
		/// </summary>
		protected readonly Vector2 DefaultSize = new Vector2(100, 20);

		/// <summary>
		/// Create game object with component of the specified type.
		/// </summary>
		/// <typeparam name="T">Type of the component.</typeparam>
		/// <param name="parent">Parent of the created game object.</param>
		/// <param name="name">Game object name</param>
		/// <returns>Created game object.</returns>
		protected T CreateObject<T>(Transform parent, string name = null)
		...
		/// <summary>
		/// Add layout element to game object.
		/// </summary>
		/// <param name="go">Game object.</param>
		...
		protected Transform CreateCell(Transform parent, string name, TextAnchor alignment = TextAnchor.MiddleLeft)
		{
		...
		/// <summary>
		/// Add layout group to specified game object.
		/// </summary>
		...
		protected void InitTextComponent(Text unused)
		{
			// do nothing
		}
		...
		/// </summary>
		/// <param name="text">Text component.</param>
		protected void InitTextComponent(TMPro.TextMeshProUGUI text)
		{
