...
#define UIWIDGETS_MULTIPLY_ON_ALPHA
#endif
...
// Convert from gamma colorspace to linear.
// rgb - color in the gamma colorspace.
inline half3 GammaToLinearSpace3(half3 rgb)
{
    half3 low = 0.0849710 * rgb - 0.000163029;
    half3 high = rgb * (rgb * (rgb * 0.265885 + 0.736584) - 0.00980184) + 0.00319697;

    const half3 split = (half3) 0.0725490; // Equals 18.5 / 255
    return (rgb < split) ? low : high;
}
