namespace UIWidgets
{
	...
	public static class Utilites
	{
		...
		public static void CopyRectTransformValues(RectTransform source, RectTransform target) => Utilities.CopyRectTransformValues(source, target);
		...
		public static Func<bool, float> GetTime => x => WidgetsTime.Instance.Time(x);
		...
		public static Func<float> GetUnscaledTime => () => WidgetsTime.Instance.Time(true);
		...
		public static Func<bool, float> GetDeltaTime => x => WidgetsTime.Instance.DeltaTime(x);
		...
		public static float DefaultGetTime(bool unscaledTime) => WidgetsTime.Instance.DeltaTime(unscaledTime);
		...
		public static float DefaultGetUnscaledTime() => UtilitiesTime.DefaultGetUnscaledTime();
		...
		public static float DefaultGetDeltaTime(bool unscaledTime) => UtilitiesTime.DefaultGetDeltaTime(unscaledTime);
		...
		public static IEnumerator WaitForSecondsUnscaled(float seconds) => WidgetsTime.Instance.Wait(seconds, true);
		...
		public static void CheckRunTime(Action action, string log = "") => UtilitiesTime.CheckRunTime(action, log);
		#endregion
		...
		public static string GetFriendlyTypeName(Type type) => UtilitiesEditor.GetFriendlyTypeName(type);
		...
		public static Type GetType(string typename) => UtilitiesEditor.GetType(typename);
		...
		public static GameObject CreateGameObject(GameObject prefab, bool undo = true) => null;
		...
		public static string GetAssetPath(string label) => UtilitiesEditor.GetAssetPath(label);
		...
		public static GameObject GetPrefab(string label) => UtilitiesEditor.GetPrefab(label);
		...
		public static GameObject GetGeneratedPrefab(string label) => UtilitiesEditor.GetGeneratedPrefab(label);
		...
		public static void SetPrefabLabel(UnityEngine.Object prefab) => UtilitiesEditor.SetPrefabLabel(prefab);
		...
		public static GameObject CreateWidgetTemplateFromAsset(string templateLabel) => null;
		...
		public static GameObject CreateWidgetFromAsset(string widget, bool applyStyle = true, Action<GameObject> converter = null) => null;
		...
		public static GameObject CreateWidgetFromPrefab(GameObject prefab, bool applyStyle = true, Action<GameObject> converter = null) => null;
		...
		public static Transform GetCanvasTransform() => null;
		...
		public static string Serialize(object obj) => UtilitiesEditor.Serialize(obj);
		...
		public static T Deserialize<T>(string encoded) => UtilitiesEditor.Deserialize<T>(encoded);
#endif
		#endregion
		...
		public static ObservableList<T> FindAll<T>(List<T> source, Predicate<T> match)
		{
