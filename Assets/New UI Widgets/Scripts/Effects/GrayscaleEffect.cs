namespace UIWidgets
{
	...
	public class GrayscaleEffect : UVEffect
	{
		...
		protected override void SetMaterialProperties()
		{
			...
			{
				EffectMaterial.SetColor(StaticFields.Instance.ShaderGrayscaleRate, rate);
				EffectMaterial.SetFloat(StaticFields.Instance.ShaderGrayscaleEnabled, GrayscaleEnabled ? 1f : 0f);
			}
		}
	}
}