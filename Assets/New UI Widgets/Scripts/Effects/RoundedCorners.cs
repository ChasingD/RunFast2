	...
	public class RoundedCorners : UVEffect
	{
		...
		protected override void SetMaterialProperties()
		{
			if (EffectMaterial != null)
			{
				...
				EffectMaterial.SetFloat(StaticFields.Instance.ShaderCornersBorderRadius, radius);
				EffectMaterial.SetFloat(StaticFields.Instance.ShaderCornersBorderWidth, width);
				EffectMaterial.SetColor(StaticFields.Instance.ShaderCornersBorderColor, BorderColor);
			}
		}
