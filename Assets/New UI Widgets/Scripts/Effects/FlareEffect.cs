namespace UIWidgets
{
	...
	public class FlareEffect : UVEffect
	{
		...
		protected override void SetMaterialProperties()
		{
			...
			{
				EffectMaterial.SetColor(StaticFields.Instance.ShaderFlareColor, color);
				EffectMaterial.SetFloat(StaticFields.Instance.ShaderFlareSize, Size);
				EffectMaterial.SetFloat(StaticFields.Instance.ShaderFlareSpeed, Speed);
				EffectMaterial.SetFloat(StaticFields.Instance.ShaderFlareDelay, StartPosition);
				EffectMaterial.SetFloat(StaticFields.Instance.ShaderFlareHeightDelay, Angle);
			}
		}
