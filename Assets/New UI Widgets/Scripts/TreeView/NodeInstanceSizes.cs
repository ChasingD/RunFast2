namespace UIWidgets.Internal
{
	...
	public class NodeInstanceSizes<TItem> : IInstanceSizes<ListNode<TItem>>
	{
		...
		public int Visible(ObservableList<ListNode<TItem>> items, bool horizontal, float visibleArea, float spacing, bool smallestSize = true)
		{
			...
			{
				sorted_sizes.Sort((a, b) => b.CompareTo(a));
			}
