namespace UIWidgets
{
	...
	public class TreeNode<TItem> : ObservableDataWithPropertyChanged, IEquatable<TreeNode<TItem>>
	{
		[SerializeField]
		bool isVisible = true;
		...
		public bool IsVisible
		{
			...
			set => Change(ref isVisible, value);
		}
		...
		public bool IsExpanded
		{
			...
			set => Change(ref isExpanded, value);
		}
		...
		private static bool IsValueType => ObservableInfo<TItem>.Instance.IsValueType;

		private static bool IsItemsObservable => ObservableInfo<TItem>.Instance.IsObservable;

		private static bool IsItemsSupportNotifyPropertyChanged => ObservableInfo<TItem>.Instance.IsNotifyPropertyChanged;
		...
		void NotifyPropertyChanged() => Changed(nameof(Nodes));

		void ItemChanged() => Changed(nameof(Item));

		void ItemPropertyChanged(object sender, PropertyChangedEventArgs e) => Changed(nameof(Item));
