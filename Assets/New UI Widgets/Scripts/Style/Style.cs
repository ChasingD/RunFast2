namespace UIWidgets.Styles
{
	...
	public class Style : ScriptableObject, IStyleDefaultValues, IUpgradeable
	{
		...
		/// <summary>
		/// The function to process TMPro game object.
		/// </summary>
		public static Func<StyleText, GameObject, bool> TMProSupport => StaticFields.Instance.StyleTMProSupport;

		/// <summary>
		/// The function to process TMPro game object.
		/// </summary>
		public static Func<StyleText, GameObject, bool> TMProSupportGetFrom => StaticFields.Instance.StyleTMProSupportGetFrom;
