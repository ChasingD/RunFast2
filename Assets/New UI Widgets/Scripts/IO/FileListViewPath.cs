namespace UIWidgets
{
	...
	public class FileListViewPath : UIBehaviourInteractable, IStylable
	{
		...
		[SerializeField]
		[HideInInspector]
		protected BasePool<FileListViewPathComponentBase> Cache;
		...
		{
			Cache = new BasePool<FileListViewPathComponentBase>(Template);
		...
		public virtual bool SetStyle(Style style)
		{
			...
			{
				c.SetStyle(style.FileListView.PathItemBackground, style.FileListView.PathItemText, style);
			}
