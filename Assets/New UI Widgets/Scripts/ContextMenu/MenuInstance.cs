namespace UIWidgets.Menu
{
	...
	public partial class ContextMenu : UIBehaviourInteractable, IPointerDownHandler, IPointerUpHandler, IPointerClickHandler
	{
		...
		protected class MenuInstance : IMenuSubscriber, IStylable
		{
			...
			/// The modal ID.
			/// </summary>
			protected UIWidgets.InstanceID? ModalKey;
			...
			/// </summary>
			protected bool PointerOver => (View != null) && View.IsPointerOver;
			...
			{
				yield return WidgetsTime.Instance.Wait(Owner.SubmenuDelay, Owner.UnscaledTime);
				OpenSubmenu(index);
			}
