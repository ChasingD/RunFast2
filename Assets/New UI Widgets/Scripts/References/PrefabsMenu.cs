namespace UIWidgets
{
	...
	public class PrefabsMenu : ScriptableObject
	{
		...
		/// Instance.
		/// </summary>
		public static PrefabsMenu Instance => StaticFields.Instance.References.PrefabsMenu;
#endif
		...
		/// </summary>
		[SerializeField]
		public GameObject DateYearListPicker;

		/// <summary>
		/// DateYearSpinnerPicker.
		/// </summary>
		[SerializeField]
		[FormerlySerializedAs("DateSpinnerPicker")]
		public GameObject DateYearSpinnerPicker;
		...
		/// </summary>
		[SerializeField]
		public GameObject CalendarYearList;

		/// <summary>
		/// CalendarYearSpinner.
		/// </summary>
		[SerializeField]
		[FormerlySerializedAs("CalendarSpinner")]
		public GameObject CalendarYearSpinner;
