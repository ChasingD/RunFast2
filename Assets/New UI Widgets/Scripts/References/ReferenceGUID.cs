...
namespace UIWidgets
{
	...
	/// GUID list.
	/// </summary>
	public class ReferenceGUID
	{
		/// <summary>
		/// Instance.
		/// </summary>
		public static ReferenceGUID Instance => StaticFields.Instance.ReferenceGUID;
		...
		/// </summary>
		public string TMProStatus => AssetDatabase.GUIDToAssetPath(TMProStatusGUID);

		/// <summary>
		/// Directories and files to recompile when TMPro support enabled.
		/// </summary>
		public readonly string[] TMProSupport = new string[]
		{
		...
		/// </summary>
		public string DataBindFolder => AssetDatabase.GUIDToAssetPath(DataBindFolderGUID);
		...
		/// </summary>
		public string DataBindStatus => AssetDatabase.GUIDToAssetPath(DataBindStatusGUID);

		/// <summary>
		/// Directories and files to recompile when DataBind support enabled.
		/// </summary>
		public readonly string[] DataBindSupport = new string[]
		{
		...
		/// </summary>
		public string I2LocalizationStatus => AssetDatabase.GUIDToAssetPath(I2LocalizationStatusGUID);

		/// <summary>
		/// Directories and files to recompile when I2 Localization support enabled.
		/// </summary>
		public readonly string[] I2LocalizationSupport = new string[]
		{
		...
		/// Scripts folder.
		/// </summary>
		public string ScriptsFolder => AssetDatabase.GUIDToAssetPath(ScriptsFolderGUID);
		...
		/// Editor folder.
		/// </summary>
		public string EditorFolder => AssetDatabase.GUIDToAssetPath(EditorFolderGUID);
		...
		/// Samples folder.
		/// </summary>
		public string SamplesFolder => AssetDatabase.GUIDToAssetPath(SamplesFolderGUID);
		...
		/// </summary>
		public string AsmdefTemplateFile => AssetDatabase.GUIDToAssetPath(AsmdefTemplateGUID);

		/// <summary>
		/// Assembly definition template.
		/// </summary>
		public string AsmdefTemplate
		{
			get
			{
