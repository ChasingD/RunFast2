namespace UIWidgets
{
		...
		where TDialog : DialogCustom<TDialog>, IHideable
	{
		...
		/// Buttons pool.
		/// </summary>
		protected ButtonsPool Buttons => buttonsPool ??= new ButtonsPool(this as TDialog, ButtonsTemplates, ButtonsContainer, ButtonsActive, ButtonsCached);
		...
		static WindowInstances<TDialog> Instances => WindowInstances<TDialog>.Instance;
		...
		public static Templates<TDialog> Templates
		{
			...
			set => Instances.Templates = value;
		}

		/// <summary>
		/// Opened dialogs.
		/// </summary>
		public static IReadOnlyList<TDialog> OpenedDialogs => Instances.Opened;

		/// <summary>
		/// All dialogs.
		/// </summary>
		public static List<TDialog> AllDialogs => Instances.All;
		...
		{
			add => Instances.OnOpen += value;

			remove => Instances.OnOpen -= value;
		}
		...
		{
			add => Instances.OnClose += value;

			remove => Instances.OnClose -= value;
		}
		...
		/// </summary>
		public static int Opened => Instances.Count;
		...
		{
			output.AddRange(Instances.Opened);
		}
		...
		protected override void OnEnable()
		{
			if (!IsTemplate)
			{
				Instances.Add(this as TDialog, true);
			}
		...
		protected override void OnDisable()
		{
			if (!IsTemplate)
			{
				Instances.Remove(this as TDialog, true);
			}
		}
		...
		{
			Instances.Remove(this as TDialog);
			base.InstanceClosed();
		}
