namespace UIWidgets
{
	...
	public class Popup : MonoBehaviourInitiable, ITemplatable, IStylable, IUpgradeable, INotifyCompletion
	{
		...
		{
			get => WindowInstances<Popup>.Instance.Templates;
			set => WindowInstances<Popup>.Instance.Templates = value;
		}

		/// <summary>
		/// Opened popups.
		/// </summary>
		public static IReadOnlyList<Popup> OpenedPopups => WindowInstances<Popup>.Instance.Opened;
		...
		{
			add => WindowInstances<Popup>.Instance.OnOpen += value;

			remove => WindowInstances<Popup>.Instance.OnOpen -= value;
		}
		...
		{
			add => WindowInstances<Popup>.Instance.OnClose += value;

			remove => WindowInstances<Popup>.Instance.OnClose -= value;
		}

		/// <summary>
		/// All popup.
		/// </summary>
		public static List<Popup> AllPopups => WindowInstances<Popup>.Instance.All;

		/// <summary>
		/// Count of the opened popups.
		/// </summary>
		public static int Opened => WindowInstances<Popup>.Instance.Count;
		...
		protected virtual void InstanceOpened()
		{
			...
			WindowInstances<Popup>.Instance.Add(this);
		...
		{
			WindowInstances<Popup>.Instance.Remove(this);
		}
		...
		public virtual RectTransform SetCanvas(Canvas canvas, bool worldPositionStays = true)
		{
