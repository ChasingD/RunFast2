namespace UIWidgets
{
	...
	{
		static Dictionary<InstanceID, ModalHelper> Used => StaticFields.Instance.ModalHelperInstances;

		static Templates<ModalHelper> Templates => StaticFields.Instance.ModalHelperTemplates;

		static string Key => StaticFields.Instance.ModalHelperKey;
