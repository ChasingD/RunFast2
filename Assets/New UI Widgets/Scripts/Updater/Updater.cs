namespace UIWidgets
{
	...
	{
		static IUpdaterProxy ProxyInstance => StaticFields.Instance.UpdaterProxyInstance;
		...
		{
			get => StaticFields.Instance.UpdaterProxy;
			set => StaticFields.Instance.UpdaterProxy = value;
		}
