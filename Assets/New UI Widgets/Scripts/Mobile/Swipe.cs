namespace UIWidgets
{
	...
	public partial class Swipe : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IPointerClickHandler
	{
		/// <summary>
		/// Direction.
		/// </summary>
		...
		public void OnBeginDrag(PointerEventData eventData)
		{
			...
			start = WidgetsTime.Instance.Time(UnscaledTime);
		...
		public void OnEndDrag(PointerEventData eventData)
		{
			...
			var time = WidgetsTime.Instance.Time(UnscaledTime);
