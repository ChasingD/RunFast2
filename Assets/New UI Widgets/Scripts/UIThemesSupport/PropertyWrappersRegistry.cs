...
namespace UIWidgets.UIThemesSupport
{
	...
	public static class PropertyWrappersRegistry
	{
		...
		public static void AddWrappers()
		{
			...
			// Tabs
			// 30 is the maximum supported size of the TabsObjects array and can be changed
			for (var i = 0; i < 30; i++)
			{
				PropertyWrappers<Sprite>.Add(new TabsIconsWrapper(false, i));
				PropertyWrappers<Sprite>.Add(new TabsIconsWrapper(true, i));
			}
		}
	}
}
