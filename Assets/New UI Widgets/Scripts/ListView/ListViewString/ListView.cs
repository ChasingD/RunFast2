...
#pragma warning restore 0612,0618
		...
		public override bool IsVisible(int index, float minVisiblePart = 0f)
		{
			...
			var viewport_top = GetScrollValue() + LayoutBridge.GetMargin(false);
			var viewport_bottom = viewport_top + GetScrollRectSize() - LayoutBridge.GetMargin(false);
		...
		{
			return GetItemPosition(index) + GetItemSize() + LayoutBridge.GetMargin(false) - GetScrollSize();
		}
