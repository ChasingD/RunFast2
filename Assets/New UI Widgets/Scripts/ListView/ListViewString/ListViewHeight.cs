namespace UIWidgets
{
	...
	public class ListViewHeight : ListView
	{
		...
		public override void ScrollTo(int index)
		{
			...
			var item_ends = ItemEndAt(index) + LayoutBridge.GetMargin(false);
		...
		{
			return GetItemPosition(index) + GetItemHeight(DataSource[index]) + LayoutBridge.GetMargin(false) - GetScrollSize();
		}
		...
		object lockObjectHeight = new object();
