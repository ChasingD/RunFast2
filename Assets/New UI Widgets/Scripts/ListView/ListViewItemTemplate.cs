namespace UIWidgets
{
			...
			IStylable, IUpgradeable
	{
			...
			where TItemView : ListViewItem
		{
			...
			/// Instances.
			/// </summary>
			public InstancesCollection<TItemView> Instances => instances ??= new InstancesCollection<TItemView>(instancesList);
			...
			{
				instancesList.RemoveAll(StaticFields.Instance.ListViewItemIsNull);
				Requested.RemoveAll(StaticFields.Instance.ListViewItemIsNull);
				Cache.RemoveAll(StaticFields.Instance.ListViewItemIsNull);
			}
			...
			protected virtual Vector2 GetSize()
			{
				...
				layout_elements.Sort(StaticFields.Instance.ILayoutElementComparisonReverse);
			...
			public virtual void RequestInstances(ListViewBase owner, InstanceID ownerID)
			{
				...
				Requested.Sort(StaticFields.Instance.ListViewItemsIndexComparison);
			}
