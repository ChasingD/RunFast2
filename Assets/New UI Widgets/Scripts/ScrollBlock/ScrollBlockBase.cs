namespace UIWidgets
{
		...
		IBeginDragHandler, IDragHandler, IEndDragHandler, IInitializePotentialDragHandler, IScrollHandler
	{
		...
		/// </summary>
		public static Func<int, string> DefaultValue => StaticFields.Instance.ScrollBlockDefaultValue;

		/// <summary>
		/// Default function to check is interactable.
		/// </summary>
		protected static Func<bool> DefaultInteractable => StaticFields.Instance.ScrollBlockDefaultInteractable;

		/// <summary>
		/// Default function to check is action allowed.
		/// </summary>
		protected static Func<bool> DefaultAllow => StaticFields.Instance.ScrollBlockDefaultAllow;
