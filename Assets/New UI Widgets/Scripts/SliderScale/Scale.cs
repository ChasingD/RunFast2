namespace UIWidgets
{
	...
	public class Scale : MonoBehaviourConditional, IObservable, INotifyPropertyChanged, IStylable
	{
		...
		public readonly struct MarkData : IEquatable<MarkData>
		{
			...
			public override int GetHashCode() => HashCode.Combine(Position, Rotation, AnchorMin, AnchorMax, Pivot, Value, Value2Label);
		...
		/// Items comparison.
		/// </summary>
		public static Comparison<ScaleMark> MarkComparison => StaticFields.Instance.ScaleMarkComparison;
