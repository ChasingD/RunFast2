	...
	public class ColorPickerHSVPalette : ColorPickerBlock
	{
		...
		protected virtual void UpdateViewReal()
		{
			...
			if (sliderBackground != null)
			{
				...
				sliderBackground.material.SetVector(StaticFields.Instance.ShaderColorBottom, colors[0]);
				sliderBackground.material.SetVector(StaticFields.Instance.ShaderColorTop, colors[1]);
			...
			if (palette != null)
			{
				if (IsCircle)
				{
					...
					palette.material.SetFloat(StaticFields.Instance.ShaderQuality, quality);
					palette.material.SetFloat(StaticFields.Instance.ShaderValue, currentColorHSV.V / 255f);
				...
				else
				{
					...
					palette.material.SetVector(StaticFields.Instance.ShaderColorLeft, colors[0]);
					palette.material.SetVector(StaticFields.Instance.ShaderColorRight, colors[1]);
					palette.material.SetVector(StaticFields.Instance.ShaderColorBottom, colors[2]);
					palette.material.SetVector(StaticFields.Instance.ShaderColorTop, colors[3]);
					palette.SetMaterialDirty();
				}
			}
		...
		{
			var k = 2f; // because color = sum of horizontal and vertical lerp, without it parameter will be doubled
			return paletteMode switch
			{
				ColorPickerPaletteMode.Hue => new Color[]
				{
					new Color(currentColorHSV.H / 359f / k, 0f, 0f, 1f),
					new Color(currentColorHSV.H / 359f / k, 1f, 0f, 1f),
					new Color(currentColorHSV.H / 359f / k, 0f, 0f, 1f),
					new Color(currentColorHSV.H / 359f / k, 0f, 1f, 1f),
				},
				ColorPickerPaletteMode.Saturation => new Color[]
				{
					new Color(0f, currentColorHSV.S / 255f / k, 0f, 1f),
					new Color(1f, currentColorHSV.S / 255f / k, 0f, 1f),
					new Color(0f, currentColorHSV.S / 255f / k, 0f, 1f),
					new Color(0f, currentColorHSV.S / 255f / k, 1f, 1f),
				},
				ColorPickerPaletteMode.Value => new Color[]
				{
					new Color(0f, 0f, currentColorHSV.V / 255f / k, 1f),
					new Color(1f, 0f, currentColorHSV.V / 255f / k, 1f),
					new Color(0f, 0f, currentColorHSV.V / 255f / k, 1f),
					new Color(0f, 1f, currentColorHSV.V / 255f / k, 1f),
				},
				_ => new Color[]
				{
