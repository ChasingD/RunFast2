namespace UIWidgets
{
	...
	public class ColorPickerRGBBlock : ColorPickerBlock
	{
		...
		protected virtual void UpdateViewReal()
		{
			...
			{
				rSliderBackground.material.SetColor(StaticFields.Instance.ShaderColorLeft, new Color32(0, currentColor.g, currentColor.b, 255));
				rSliderBackground.material.SetColor(StaticFields.Instance.ShaderColorRight, new Color32(255, currentColor.g, currentColor.b, 255));
				rSliderBackground.SetMaterialDirty();
			}

			if (gSliderBackground != null)
			{
				gSliderBackground.material.SetColor(StaticFields.Instance.ShaderColorLeft, new Color32(currentColor.r, 0, currentColor.b, 255));
				gSliderBackground.material.SetColor(StaticFields.Instance.ShaderColorRight, new Color32(currentColor.r, 255, currentColor.b, 255));
				gSliderBackground.SetMaterialDirty();
			}

			if (bSliderBackground != null)
			{
				bSliderBackground.material.SetColor(StaticFields.Instance.ShaderColorLeft, new Color32(currentColor.r, currentColor.g, 0, 255));
				bSliderBackground.material.SetColor(StaticFields.Instance.ShaderColorRight, new Color32(currentColor.r, currentColor.g, 255, 255));
