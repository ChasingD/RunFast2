	...
	public class ColorPickerRGBPalette : ColorPickerBlock
	{
		...
		protected virtual void UpdateViewReal()
		{
			...
			if (sliderBackground != null)
			{
				...
				sliderBackground.material.SetColor(StaticFields.Instance.ShaderColorBottom, colors[0]);
				sliderBackground.material.SetColor(StaticFields.Instance.ShaderColorTop, colors[1]);
			...
			if (palette != null)
			{
				...
				palette.material.SetColor(StaticFields.Instance.ShaderColorLeft, colors[0]);
				palette.material.SetColor(StaticFields.Instance.ShaderColorRight, colors[1]);
				palette.material.SetColor(StaticFields.Instance.ShaderColorBottom, colors[2]);
				palette.material.SetColor(StaticFields.Instance.ShaderColorTop, colors[3]);
