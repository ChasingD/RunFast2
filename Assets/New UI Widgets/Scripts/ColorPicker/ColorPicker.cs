namespace UIWidgets
{
	...
	public class ColorPicker : UIBehaviourInteractable, IStylable
	{
		...
		public void TogglePaletteMode()
		{
			...
			if (rgbPalette != null)
			{
				modes.AddRange(StaticFields.Instance.RGBPaletteModes);
			}

			if (hsvPalette != null)
			{
				modes.AddRange(StaticFields.Instance.HSVPaletteModes);
			}

			if ((imagePalette != null) && (imagePalette.Image.sprite != null))
			{
				modes.AddRange(StaticFields.Instance.ImagePaletteModes);
			}
