namespace UIWidgets
{
	...
	public class ColorPickerRangeHSV : ColorPickerBlock, IStylable
	{
		...
		protected virtual void UpdateViewReal()
		{
			...
			{
				sliderBackground.material.SetVector(StaticFields.Instance.ShaderColorLeft, ColorLeft.ShaderColor);
				sliderBackground.material.SetVector(StaticFields.Instance.ShaderColorRight, ColorRight.ShaderColor);
				sliderBackground.SetMaterialDirty();
			}
			else
			{
				sliderBackground.material.SetVector(StaticFields.Instance.ShaderColorBottom, ColorLeft.ShaderColor);
				sliderBackground.material.SetVector(StaticFields.Instance.ShaderColorTop, ColorRight.ShaderColor);
				sliderBackground.SetMaterialDirty();
			}
