namespace UIWidgets
{
	...
	public class ColorPickerRange : ColorPickerBlock, IStylable
	{
		...
		protected virtual void UpdateViewReal()
		{
			...
			{
				sliderBackground.material.SetColor(StaticFields.Instance.ShaderColorLeft, ColorLeft);
				sliderBackground.material.SetColor(StaticFields.Instance.ShaderColorRight, ColorRight);
				sliderBackground.SetMaterialDirty();
			}
			else
			{
				sliderBackground.material.SetColor(StaticFields.Instance.ShaderColorBottom, ColorLeft);
				sliderBackground.material.SetColor(StaticFields.Instance.ShaderColorTop, ColorRight);
				sliderBackground.SetMaterialDirty();
			}
