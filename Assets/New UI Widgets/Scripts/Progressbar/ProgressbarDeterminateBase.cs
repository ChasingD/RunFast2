		...
		IEnumerator AnimationPerOne(int targetValue)
		{
			...
			if (delta != 0)
			{
				...
				do
				{
					...
					yield return WidgetsTime.Instance.Wait(Speed, UnscaledTime);
				}
		...
		protected void ToggleTextType()
		{
			switch (TextType)
			{
				...
				case ProgressbarTextTypes.Range:
					...
					break;
				default:
					Debug.LogWarning(string.Format("Unknown TextType: {0}", EnumHelper<ProgressbarTextTypes>.Instance.ToString(TextType)));
					break;
			}
		}
