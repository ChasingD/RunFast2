namespace UIWidgets
{
	...
	/// Tabs.
	/// </summary>
	public class Tabs : TabsBase, IUpgradeable
		...
		#endif
	{
		...
		public readonly struct AnimationData
		{
			...
			/// Previous tab.
			/// </summary>
			public readonly Tab PreviousTab;

			/// <summary>
			/// Current tab.
			/// </summary>
			public readonly Tab CurrentTab;
			...
			public AnimationData(Tab previousTab, Tab currentTab, float duration, bool unscaledTime)
			{
		...
		/// </summary>
		public static Func<Tab, bool> AllowSelect => StaticFields.Instance.TabsAllowSelect;
