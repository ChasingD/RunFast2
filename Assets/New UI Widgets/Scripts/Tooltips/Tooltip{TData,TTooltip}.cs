namespace UIWidgets
{
		...
		where TTooltip : Tooltip<TData, TTooltip>
	{
		...
		/// </summary>
		protected static bool IsValueType => ObservableInfo<TData>.Instance.IsValueType;

		/// <summary>
		/// Data type implements IObservable.
		/// </summary>
		protected static bool IsDataObservable => ObservableInfo<TData>.Instance.IsObservable;

		/// <summary>
		/// Data type implements INotifyPropertyChanged.
		/// </summary>
		protected static bool IsDataNotifyPropertyChanged => ObservableInfo<TData>.Instance.IsNotifyPropertyChanged;
