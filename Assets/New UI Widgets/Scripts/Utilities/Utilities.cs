namespace UIWidgets
{
	...
	public static class Utilities
	{
		...
		public static Vector2 GetTopLeftCorner(RectTransform target) => UtilitiesRectTransform.GetTopLeftCorner(target);
		...
		public static void SetTopLeftCorner(RectTransform target, Vector2 position) => UtilitiesRectTransform.SetTopLeftCorner(target, position);
		...
		public static Vector2 GetTopLeftCornerGlobalPosition(RectTransform target) => UtilitiesRectTransform.GetTopLeftCornerGlobalPosition(target, null);
		...
		public static Vector3 GetTopRightCornerGlobalPosition(RectTransform target) => UtilitiesRectTransform.GetTopRightCornerGlobalPosition(target);
		...
		public static void CopyRectTransformValues(RectTransform source, RectTransform target) => UtilitiesRectTransform.CopyValues(source, target);
		#endregion
		...
		public static Func<bool, float> GetTime => UtilitiesTime.DefaultGetTime;
		...
		public static Func<float> GetUnscaledTime => UtilitiesTime.DefaultGetUnscaledTime;
		...
		public static Func<bool, float> GetDeltaTime => UtilitiesTime.DefaultGetDeltaTime;
		...
		public static float DefaultGetTime(bool unscaledTime) => UtilitiesTime.DefaultGetTime(unscaledTime);
