namespace UIWidgets
{
	...
	public static class Animations
	{
		...
		{
			return Collapse(rectTransform, time,  StaticFields.Instance.LinearCurve, isHorizontal, unscaledTime, actionAfter);
		}
		...
		{
			return CollapseFlexible(rectTransform, time, StaticFields.Instance.LinearCurve, isHorizontal, unscaledTime, actionAfter);
		}
		...
		{
			return Open(rectTransform, time, StaticFields.Instance.LinearCurve, isHorizontal, unscaledTime, actionAfter);
		}
		...
		{
			return OpenFlexible(rectTransform, time, StaticFields.Instance.LinearCurve, isHorizontal, unscaledTime, actionAfter);
		}
