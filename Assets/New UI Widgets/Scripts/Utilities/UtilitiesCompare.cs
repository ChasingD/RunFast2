namespace UIWidgets
{
	...
	public static class UtilitiesCompare
	{
		...
		/// Culture.
		/// </summary>
		public static ref CultureInfo Culture => ref StaticFields.Instance.CompareCulture;

		/// <summary>
		/// Case sensitive compare options.
		/// </summary>
		public static ref CompareOptions OptionsCaseSensitive => ref StaticFields.Instance.CompareOptionsCaseSensitive;

		/// <summary>
		/// Case ignore compare options.
		/// </summary>
		public static ref CompareOptions OptionsCaseIgnore => ref StaticFields.Instance.CompareOptionsCaseIgnore;
