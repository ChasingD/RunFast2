namespace UIWidgets
{
	...
	public static class UtilitiesTime
	{
		...
		/// </summary>
		[Obsolete("Replaced with WidgetsTime.Instance.Time()")]
		public static Func<bool, float> GetTime => WidgetsTime.Instance.Time;

		/// <summary>
		/// Function to get delta time to use with animations.
		/// Can be replaced with custom function.
		/// </summary>
		[Obsolete("Replaced with WidgetsTime.Instance.DeltaTime()")]
		public static Func<bool, float> GetDeltaTime => WidgetsTime.Instance.DeltaTime;

		/// <summary>
		/// Function to get frame count.
		/// Can be replaced with custom function.
		/// </summary>
		[Obsolete("Replaced with WidgetsTime.Instance.FrameCount")]
		public static Func<int> GetFrameCount => () => WidgetsTime.Instance.FrameCount;

		/// <summary>
		/// Suspends the coroutine execution for the given amount of seconds.
		/// Can be replaced with custom function.
		/// </summary>
		[Obsolete("Replaced with WidgetsTime.Instance.Wait")]
		public static Func<float, bool, CustomYieldInstruction> Wait => WidgetsTime.Instance.Wait;

		/// <summary>
		/// Default GetFrameCount function from the default Time class.
		/// </summary>
		/// <returns>Frame count.</returns>
		public static int DefaultGetFrameCount() => Time.frameCount;
		...
		public static float DefaultGetTime(bool unscaledTime) => unscaledTime ? Time.unscaledTime : Time.time;
		...
		public static CustomYieldInstruction DefaultWait(float seconds, bool unscaledTime = false) => WaitForSecondsCustom.Instance(seconds, unscaledTime);

		/// <summary>
		/// Default GetUnscaledTime function.
		/// </summary>
		/// <returns>Default Time.unscaledTime.</returns>
		public static float DefaultGetUnscaledTime() => Time.unscaledTime;
		...
		public static float DefaultGetDeltaTime(bool unscaledTime) => unscaledTime ? Time.unscaledDeltaTime : Time.deltaTime;
