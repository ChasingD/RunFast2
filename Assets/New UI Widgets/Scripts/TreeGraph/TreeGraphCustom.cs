namespace UIWidgets
{
	...
	public class TreeGraphCustom<TItem, TItemView> : MonoBehaviourInitiable, IStylable, IUpdatable
...
#pragma warning restore 0219
		...
		protected virtual Vector2 GetStartPosition()
		{
			...
			return Direction switch
			{
				...
				_ => throw new NotSupportedException(string.Format("Unsupported direction: {0}", EnumHelper<TreeGraphDirections>.Instance.ToString(Direction))),
			};
		}
			...
			if (connector != null)
			{
				...
				switch (Direction)
				{
					...
					case TreeGraphDirections.RightToLeft:
						...
						break;
					default:
						throw new NotSupportedException(string.Format("Unsupported direction: {0}", EnumHelper<TreeGraphDirections>.Instance.ToString(Direction)));
				}
